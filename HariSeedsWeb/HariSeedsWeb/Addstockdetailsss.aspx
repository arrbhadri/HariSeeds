<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Addstockdetailsss.aspx.cs"
    Inherits="HariSeedsWeb.Addstockdetailsss" %>
        ...
        <div>
            ...
            <div>
                <asp:GridView ID="Griddetails" runat="server" AutoGenerateColumns="False" AllowPaging="true"
                    AllowSorting="true" Width="921px" ShowFooter="True" OnSelectedIndexChanged="Griddetails_SelectedIndexChanged">
                    <Columns>
