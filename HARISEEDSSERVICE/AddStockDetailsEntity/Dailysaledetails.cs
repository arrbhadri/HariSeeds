...
namespace Stock
{
    ...
    public class Requestdailysaledetails
    {
        public Dailysaledetails DailyStockDetails { get; set; }
    }
    public class Responsedailysaledetails
    {
